...
class AssessmentController extends BaseApiController
{
    ...
    {
        $parameters = [
            ['key' => 'pain_score',            'label' => 'Pain Score (0–10)',          'unit' => 'score', 'icon' => 'pain'],
            ['key' => 'lumbar_flexion',         'label' => 'Lumbar Flexion (°)',         'unit' => '°',     'icon' => 'flexion'],
            ['key' => 'lumbar_extension',       'label' => 'Lumbar Extension (°)',       'unit' => '°',     'icon' => 'extension'],
            ['key' => 'side_flexion_right',     'label' => 'Side Flexion Right (°)',     'unit' => '°',     'icon' => 'flexion_r'],
            ['key' => 'side_flexion_left',      'label' => 'Side Flexion Left (°)',      'unit' => '°',     'icon' => 'flexion_l'],
            ['key' => 'core_strength',          'label' => 'Core Strength',              'unit' => 'grade', 'icon' => 'core'],
            ['key' => 'walking_tolerance',      'label' => 'Walking Tolerance (min)',    'unit' => 'min',   'icon' => 'walk'],
            ['key' => 'sitting_tolerance',      'label' => 'Sitting Tolerance (min)',    'unit' => 'min',   'icon' => 'sit'],
            ['key' => 'standing_tolerance',     'label' => 'Standing Tolerance (min)',   'unit' => 'min',   'icon' => 'stand'],
            ['key' => 'functional_disability',  'label' => 'Functional Disability (ODI%)', 'unit' => '%',  'icon' => 'odi'],
            ['key' => 'straight_leg_raise_r',   'label' => 'Straight Leg Raise (R)',     'unit' => '°',     'icon' => 'slr'],
            ['key' => 'straight_leg_raise_l',   'label' => 'Straight Leg Raise (L)',     'unit' => '°',     'icon' => 'slr'],
            ['key' => 'sleep_quality',          'label' => 'Sleep Quality',              'unit' => 'grade', 'icon' => 'sleep'],
        ];
