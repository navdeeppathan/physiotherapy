									...
									<div class="profile-widget">
										<div class="doc-img">
											<a href="{{ route('doctor.profile', $doctor->id) }}">
												<img class="img-fluid"
													src="{{ $doctor->profile->profile_image ?? asset('assets/img/doctors/default.jpg') }}">
											</a>
										</div>
										...
										<div class="pro-content">
											...
											<p class="speciality">
												{{ $doctor->profile->specializationdata->name ?? 'Physiotherapist' }}
											</p>

											<ul class="available-info">
												<li>
													<i class="fas fa-map-marker-alt"></i>
													{{ $doctor->profile->city ?? 'Indore' }}
												</li>

												<li>
													<i class="far fa-money-bill-alt"></i>
													₹{{ $doctor->fee->total_fee ?? 0 }}
												</li>
											</ul>
